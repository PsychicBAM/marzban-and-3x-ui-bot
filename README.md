...
- Клиентское меню: покупка, продление, «Мой VPN», инструкция, поддержка, промокоды при оплате
- Админ-панель: заявки, клиенты, тарифы, статистика, настройки, рассылки, промокоды
